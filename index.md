...
1. [反思](./stages/reflect/)：把代码的真实结构暴露出来，与预期架构逐条对照；
2. [重构](./stages/refactor/)：把差异转化为改动，先在路径推演中权衡再落地；
3. [评审](./stages/review/)：以不断开新对话的方式，检查成果与承接下一段工作的上下文。

目前已发布的是[依赖图分析](./stages/reflect/dependency-graph.md)，属第一阶段。
